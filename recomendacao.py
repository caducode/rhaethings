...
#definicoes de path
emb_path = "assets/embeddings_full.data"
...
def busca_produtos(qtd_rec=5,img_path=""):
    if(img_path):
        ...
        if(response.status_code == 200):
            ...
            img.save(os.path.join("assets/fotos",filename+"."+type_img))
    
    img_name, tensor = extract_one_img(os.path.join("assets/fotos",filename+"."+type_img))
    item = tensor[0]
